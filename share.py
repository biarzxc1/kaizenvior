...
# --- GRAYSCALE COLOR PALETTE (Obfuscator Style) ---
# Gradient from white to dark gray
W1 = '\033[38;2;255;255;255m'  # Pure white
W2 = '\033[38;2;230;230;230m'  # Very light gray
W3 = '\033[38;2;205;205;205m'  # Light gray
W4 = '\033[38;2;180;180;180m'  # Light-medium gray
W5 = '\033[38;2;155;155;155m'  # Medium gray
W6 = '\033[38;2;130;130;130m'  # Medium-dark gray
W7 = '\033[38;2;105;105;105m'  # Dark gray
W8 = '\033[38;2;80;80;80m'     # Darker gray

# Keep some colors for accents
R = '\033[1;31m'   # Red (for errors)
G = '\033[1;32m'   # Green (for success)
Y = '\033[1;33m'   # Yellow (for warnings)
W = W1             # Default white
RESET = '\033[0m'  # Reset

# Background colors (grayscale)
BG_W1 = '\033[48;2;255;255;255m'
BG_W2 = '\033[48;2;230;230;230m'
BG_W3 = '\033[48;2;205;205;205m'
BG_W4 = '\033[48;2;180;180;180m'
BG_W5 = '\033[48;2;155;155;155m'
BG_W6 = '\033[48;2;130;130;130m'
BG_W7 = '\033[48;2;105;105;105m'
BG_R = '\033[41m'  # Red Background (errors)
BG_G = '\033[42m'  # Green Background (success)
...
def banner_header():
    ...
    print(LINE)
    print(f" {W1}[{RESET}•{W1}]{RESET} {W3}{'DEVELOPER':<13} {W1}➤{RESET} {W2}KEN DRICK{RESET}")
    print(f" {W1}[{RESET}•{W1}]{RESET} {W3}{'GITHUB':<13} {W1}➤{RESET} {W2}RYO GRAHHH{RESET}")
    print(f" {W1}[{RESET}•{W1}]{RESET} {W3}{'VERSION':<13} {W1}➤{RESET} {W2}1.0.2{RESET}")
    print(f" {W1}[{RESET}•{W1}]{RESET} {W3}{'FACEBOOK':<13} {W1}➤{RESET} {W2}facebook.com/ryoevisu{RESET}")
    
    tool_name = f"{W7}[ {BG_W7}{W1}RPWTOOLS{RESET}{W7} ]{RESET}"
    print(f" {W1}[{RESET}•{W1}]{RESET} {W3}{'TOOL\'S NAME':<13} {W1}➤{RESET} {tool_name}")
    
    if user_data:
        print(LINE)
        username_display = user_data['username'].upper()
        print(f" {W1}[{RESET}•{W1}]{RESET} {W3}{'USERNAME':<13} {W1}➤{RESET} {W2}{username_display}{RESET}")
        
        fb_link = user_data.get('facebook', 'N/A')
        print(f" {W1}[{RESET}•{W1}]{RESET} {W3}{'FACEBOOK':<13} {W1}➤{RESET} {W2}{fb_link}{RESET}")
        
        country_display = user_data.get('country', 'N/A').upper()
        print(f" {W1}[{RESET}•{W1}]{RESET} {W3}{'COUNTRY':<13} {W1}➤{RESET} {W2}{country_display}{RESET}")
        
        # Color-coded plan display
        user_plan = user_data['plan']
        if user_plan == 'max':
            if user_data.get('planExpiry'):
                plan_display = f"{W6}[ {BG_W6}{W1}MAX{RESET}{W6} ]{RESET}"
            else:
                plan_display = f"{W6}[ {BG_W6}{W1}MAX LIFETIME{RESET}{W6} ]{RESET}"
        else:  # free
            plan_display = f"{W4}[ {BG_W4}{W8}FREE{RESET}{W4} ]{RESET}"
        
        print(f" {W1}[{RESET}•{W1}]{RESET} {W3}{'PLAN':<13} {W1}➤{RESET} {plan_display}")
        
        if user_data.get('planExpiry'):
            print(f" {W1}[{RESET}•{W1}]{RESET} {W3}{'PLAN EXPIRY IN':<13} {W1}➤{RESET} {Y}{user_data['planExpiry']}{RESET}")
        
        # Show cookie count
        cookie_count = user_data.get('cookieCount', 0)
        print(f" {W1}[{RESET}•{W1}]{RESET} {W3}{'TOTAL COOKIES':<13} {W1}➤{RESET} {W5}{cookie_count}{RESET}")
...
def show_menu():
    ...
    if not user_token:
        print(f" {W1}[{RESET}{BG_G}{W1}01{RESET}{BG_G}{W3}/{RESET}{BG_G}{W1}A{RESET}{W1}]{RESET} {G}LOGIN{RESET}")
        print(f" {W1}[{RESET}{BG_W5}{W1}02{RESET}{BG_W5}{W3}/{RESET}{BG_W5}{W1}B{RESET}{W1}]{RESET} {W3}REGISTER{RESET}")
        print(f" {W1}[{RESET}{BG_R}{W1}00{RESET}{BG_R}{W3}/{RESET}{BG_R}{W1}X{RESET}{W1}]{RESET} {R}EXIT{RESET}")
    elif user_data and user_data.get('isAdmin'):
        print(f" {W1}[{RESET}{BG_G}{W1}01{RESET}{BG_G}{W3}/{RESET}{BG_G}{W1}A{RESET}{W1}]{RESET} {G}AUTO SHARE              — NORM ACCOUNTS{RESET}")
        print(f" {W1}[{RESET}{BG_W5}{W1}02{RESET}{BG_W5}{W3}/{RESET}{BG_W5}{W1}B{RESET}{W1}]{RESET} {W3}MANAGE COOKIES          — DATABASE{RESET}")
        print(f" {W1}[{RESET}{BG_W4}{W1}03{RESET}{BG_W4}{W3}/{RESET}{BG_W4}{W1}C{RESET}{W1}]{RESET} {W4}MY STATS                — STATISTICS{RESET}")
        print(f" {W1}[{RESET}{BG_W6}{W1}04{RESET}{BG_W6}{W3}/{RESET}{BG_W6}{W1}D{RESET}{W1}]{RESET} {W6}ADMIN PANEL             — MANAGEMENT{RESET}")
        print(f" {W1}[{RESET}{BG_G}{W1}05{RESET}{BG_G}{W3}/{RESET}{BG_G}{W1}E{RESET}{W1}]{RESET} {G}UPDATE TOOL             — LATEST VERSION{RESET}")
        print(f" {W1}[{RESET}{BG_R}{W1}00{RESET}{BG_R}{W3}/{RESET}{BG_R}{W1}X{RESET}{W1}]{RESET} {R}LOGOUT{RESET}")
    else:
        print(f" {W1}[{RESET}{BG_G}{W1}01{RESET}{BG_G}{W3}/{RESET}{BG_G}{W1}A{RESET}{W1}]{RESET} {G}AUTO SHARE              — NORM ACCOUNTS{RESET}")
        print(f" {W1}[{RESET}{BG_W5}{W1}02{RESET}{BG_W5}{W3}/{RESET}{BG_W5}{W1}B{RESET}{W1}]{RESET} {W3}MANAGE COOKIES          — DATABASE{RESET}")
        print(f" {W1}[{RESET}{BG_W4}{W1}03{RESET}{BG_W4}{W3}/{RESET}{BG_W4}{W1}C{RESET}{W1}]{RESET} {W4}MY STATS                — STATISTICS{RESET}")
        print(f" {W1}[{RESET}{BG_G}{W1}04{RESET}{BG_G}{W3}/{RESET}{BG_G}{W1}D{RESET}{W1}]{RESET} {G}UPDATE TOOL             — LATEST VERSION{RESET}")
        print(f" {W1}[{RESET}{BG_R}{W1}00{RESET}{BG_R}{W3}/{RESET}{BG_R}{W1}X{RESET}{W1}]{RESET} {R}LOGOUT{RESET}")
...
def nice_loader(text="PROCESSING"):
    """Improved Progress Bar Loader with grayscale gradient."""
    ...
    for i in range(width + 1):
        ...
        color = G if i == width else W3
        
        sys.stdout.write(f"\r {W1}[{RESET}•{W1}]{RESET} {W3}{text:<10} {W1}➤{RESET} {color}[{bar}] {percent}%{RESET}")
        sys.stdout.flush()
        time.sleep(0.04) 
